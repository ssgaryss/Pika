...
namespace Pika {
	...
	void OpenGLContext::Initialize()
	{
		...
		m_Information.m_Renderer = reinterpret_cast<const char*>(glad_glGetString(GL_VENDOR));
		m_Information.m_Vendor = reinterpret_cast<const char*>(glad_glGetString(GL_RENDERER));
